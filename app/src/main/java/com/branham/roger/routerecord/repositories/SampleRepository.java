...
public class SampleRepository {
    ...
    private void setSampleData(){
        ...
        Trip trip1 = new Trip("Baseball To Mellen");
        trip1.setDate("5/25/19");
        trip1.setMiles(132);
        trip1.setHours(5.5f);

        Trip trip2 = new Trip("Softball To Mellen");
        trip2.setDate("5/27/19");
        trip2.setMiles(140);
        trip2.setHours(3.5f);

        Trip trip3 = new Trip("Baseball To Hurly");
        trip3.setDate("5/23/19");
        trip3.setMiles(160);
        trip3.setHours(5.6f);

        Trip trip4 = new Trip("Track To Drummond");
